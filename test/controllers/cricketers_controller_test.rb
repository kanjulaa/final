...
class CricketersControllerTest < ActionController::TestCase
  ...
  test "should create cricketer" do
    assert_difference('Cricketer.count') do
      post :create, cricketer: { fullname: @cricketer.fullname, game: @cricketer.game, name: @cricketer.name, score: @cricketer.score, strength: @cricketer.strength }
    end
  ...
  test "should update cricketer" do
    patch :update, id: @cricketer, cricketer: { fullname: @cricketer.fullname, game: @cricketer.game, name: @cricketer.name, score: @cricketer.score, strength: @cricketer.strength }
    assert_redirected_to cricketer_path(assigns(:cricketer))
  end
