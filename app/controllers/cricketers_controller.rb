  ...
  def create
    ...
    respond_to do |format|
      if @cricketer.save
        ...
        country = Country.find(cricketer_params[:country_id])
@cricketer.build_country(:id => country.id)
  ...
  private
    ...
    def cricketer_params
      params.require(:cricketer).permit(:name, :fullname, :game, :score, :strength, :country_id)
    end
end
